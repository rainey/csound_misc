...
;Widget height
	...
	;Note: this is written to work well on a 4K monitor.
			FLpanel "Gain Control", 450, giwheight*10
...
idnoise	FLvalue " ", 450, giwheight, 0, giwheight*8
...
gknoise,  ihnoise  FLslider	 "Noise (Pre-filter)", .1, 1, 0, 25, idnoise, 450, giwheight, 0, giwheight*7
...
instr 1
	...
	aMix =(ainR+ainL)/2
	aNoise gauss .1
	aFiltered lowpass2 aMix*(aNoise+gknoise), gkfreq, gkres
